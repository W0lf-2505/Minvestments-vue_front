                ...
                <div class="mb-4 card card-plain">
                    <div class="p-3 card-body">
                        ...
                        <div v-if="s_token==undefined" class="container">
                            ...
                            <VsudButton v-on:click.prevent="openPopup" id="signinButton"  class="button" v-bind:disabled="signinButtonCounter">Sign In with ICICI Direct</VsudButton>
                            <br><br>
...
import Platform from "@/views/Tradebreeze/platform.vue"
...
export default {
    ...
    cookiecheck(){
        ...
        openPopup: async function () {{
            ...
            this.success_window = window.open(url, "_blank", options);
            }
